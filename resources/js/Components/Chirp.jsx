                ...
                <div className="flex justify-between items-center">
                    ...
                    {chirp.user.id === auth.user.id &&
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                <button className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-300 hover:bg-gray-600 focus:bg-gray-100 transition duration-150 ease-in-out" onClick={() => setEditing(true)}>
                                    Edit
                                </button>
